...
void help( void )
{
  ...
  printf ("   'area' <set> \n");
  printf ("   'asgn' 'n'|'e'|'p'|'l'|'c'|'s'|'b'|'S'|'L'|'se'|'sh'|'alpha'|'beta'|'nadapt' <value>|'netgen'|'tetgen'|'thrds' <value>|['rbe' <value>|'mpc']|'max'|'maxr'|'maxc' [<col>]|'minc' [<col>]|['mem' 'free'|'keep']|'usr' <text>]|[graph on|off|<nr>]\n");
  ...
  printf ("   'gonly' 'on'|'off' \n");
  printf ("   'graph' [<amplitude|*chars*> 'amp' [<l>]]|[<material|*chars*> 'mat' [<l>]]|[<set>|'-p' ['length' ['+'|'-']]|['step'|'nr'|'freq'|'time'|'descr'|<parameter> [<dataset> <entity|parameter> [<first-Dataset-Nr> [<last-Dataset-Nr>]] ] ] ] \n");
...
int coneToNurs(int s, int flag)
{
  ...
  sem_post(&sem_g);
  rad1_prool=v_betrag(p1);
  if(shape[h].type==2)
  {
  sem_wait(&sem_g);
    v_result( &point[shape[h].p[1]].px, &point[shape[h].p[3]].px, p2  );
  sem_post(&sem_g);
    rad2_prool=v_betrag(p2);
  }
  else rad2_prool=rad1_prool;
  //printf("r1,2 %f %f\n",rad1_prool,rad2_prool);
  ...
  dl=v_betrag(p1);
  dr=rad2_prool-rad1_prool;
  qdrdl=dr/dl;
  dr2=maxlhq[0]*qdrdl;
  rad2_prool=rad1_prool+dr2;
  dr1=minlhq[0]*qdrdl;
  rad1_prool+=dr1;
  //printf("r1,2 %f %f\n",rad1_prool,rad2_prool);

  for(i=0; i<8; i++) p_lhq[i][0]=minlhq[0];
  p_lhq[0][1]=-rad1_prool;
  p_lhq[1][1]=-rad1_prool;
  p_lhq[2][1]=0.     ;
  p_lhq[3][1]= rad1_prool;
  p_lhq[4][1]= rad1_prool;
  p_lhq[5][1]= rad1_prool;
  p_lhq[6][1]=0.     ;
  p_lhq[7][1]=-rad1_prool;
  p_lhq[0][2]=0.     ;
  p_lhq[1][2]=-rad1_prool;
  p_lhq[2][2]=-rad1_prool;
  p_lhq[3][2]=-rad1_prool;
  p_lhq[4][2]=0.     ;
  p_lhq[5][2]= rad1_prool;
  p_lhq[6][2]= rad1_prool;
  p_lhq[7][2]= rad1_prool;
  for(i=8; i<16;i++) p_lhq[i][0]=maxlhq[0];
  p_lhq[8][1]=-rad2_prool;
  p_lhq[9][1]=-rad2_prool;
  p_lhq[10][1]=0.     ;
  p_lhq[11][1]= rad2_prool;
  p_lhq[12][1]= rad2_prool;
  p_lhq[13][1]= rad2_prool;
  p_lhq[14][1]=0.     ;
  p_lhq[15][1]=-rad2_prool;
  p_lhq[8][2]=0.     ;
  p_lhq[9][2]=-rad2_prool;
  p_lhq[10][2]=-rad2_prool;
  p_lhq[11][2]=-rad2_prool;
  p_lhq[12][2]=0.     ;
  p_lhq[13][2]= rad2_prool;
  p_lhq[14][2]= rad2_prool;
  p_lhq[15][2]= rad2_prool;
